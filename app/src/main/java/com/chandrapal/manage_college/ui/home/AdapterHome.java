...
public class AdapterHome extends RecyclerView.Adapter<AdapterHome.ViewHolderHome> implements Filterable {
    ...
    public AdapterHome(List<Model> dataHolder, OnShowMoreListener onShowMoreListener, OnProfileClickListener onProfileClickListener) {
    ...
    public void onBindViewHolder(@NonNull @NotNull ViewHolderHome holder, int position) {
        ...
        holder.title.setTextSize(titleTextSize);
...
//                        image = "";
    ...
    public class ViewHolderHome extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ViewHolderHome(@NonNull @NotNull View itemView, OnShowMoreListener onShowMoreListener, OnProfileClickListener onProfileClickListener) {
            ...
            profileImage.setOnClickListener(v-> onProfileClickListener.onProfileClick(getBindingAdapterPosition()));
            username.setOnClickListener(v-> onProfileClickListener.onProfileClick(getBindingAdapterPosition()));
        }
    ...
    public void notifyRecyclerview(int linearChildCount, int titleTextSize, boolean topBar, boolean secondBar, boolean showMore){
